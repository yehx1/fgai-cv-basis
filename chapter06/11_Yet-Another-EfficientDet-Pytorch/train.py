...
def get_args():
    ...
    parser.add_argument('--data_path', type=str, default=f'{current_dir}/../../01_data/coco128_coco/', help='the root folder of dataset')
    parser.add_argument('--log_path', type=str, default='logs/')
    parser.add_argument('-w', '--load_weights', type=str, default='efficientdet-d2.pth',
                        help='whether to load weights from a checkpoint, set None to initialize, set \'last\' to load last checkpoint')
    parser.add_argument('--saved_path', type=str, default=f'{save_dir}/')
        ...
        for epoch in range(opt.num_epochs):
            ...
            for iter, data in enumerate(progress_bar):
                ...
                try:
                    ...
                    optimizer.zero_grad()
                    cls_loss, reg_loss = model(imgs, annot, obj_list=params.obj_list) # FocalLoss
