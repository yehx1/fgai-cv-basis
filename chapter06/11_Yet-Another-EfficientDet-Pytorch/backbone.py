...
class EfficientDetBackbone(nn.Module):
    ...
    def forward(self, inputs):
        ...
        # torch.Size([b, 112, 96, 96]), torch.Size([b, 112, 48, 48]), torch.Size([b, 112, 24, 24]), torch.Size([b, 112, 12, 12]), torch.Size([b, 112, 6, 6])
        regression = self.regressor(features) # 96*96+48*48+24*24+12*12+6*6=12276, 12276*9=110484, torch.Size([b, 110484, 4])
