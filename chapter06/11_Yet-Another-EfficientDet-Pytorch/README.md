...
```
## 2. 下载预训练模型
- efficientdet-d2.pth：官方下载地址为[https://github.com/zylo117/Yet-Another-Efficient-Pytorch/releases/download/1.0/efficientdet-d2.pth](https://github.com/zylo117/Yet-Another-Efficient-Pytorch/releases/download/1.0/efficientdet-d2.pth)
- 本项目预训练模型存储路径：../../02_models/pretrained_models/efficientdet-d2.pth
- 本项目已训练模型存储路径：../../02_models/fgai_trained_models/chapter06/11_Yet-Another-EfficientDet-Pytorch/efficientdet-d2_499_64000.pth。
## 3. fgai-cv-basis运行方式
```
cd chapter06/11_Yet-Another-EfficientDet-Pytorch
# 复制预训练模型
cp ../../02_models/pretrained_models/efficientdet-d2.pth ./

# 训练程序，模型文件保存于result/coco
python train.py

# 推理程序，推理结果保存于chapter06/11_Yet-Another-EfficientDet-Pytorch/res/img_inferred_d2_this_repo_0.jpg
python efficientdet_test.py
```
![alt text](res/img_inferred_d2_this_repo_0.jpg)
