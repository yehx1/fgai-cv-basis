...
```
## 2. 下载预训练模型
- 本项目已训练模型存储路径：../../02_models/fgai_trained_models/chapter06/13_pytorch-retinanet/model_final.pt。
## 3. fgai-cv-basis运行方式
```
cd chapter06/13_pytorch-retinanet

# 训练程序，模型文件保存于chapter06/13_pytorch-retinanet/result/model_final.pt
python train.py

# 推理程序，推理文件保存于chapter06/13_pytorch-retinanet/result/output.png
python visualize_single_image.py
```
![alt text](result/output.png)
