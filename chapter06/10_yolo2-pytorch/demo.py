...
#     cfg.train_output_dir, 'darknet19_voc07trainval_exp3_final.h5')
trained_model = '../../02_models/fgai_trained_models/chapter06/10_yolo2-pytorch/darknet19_voc07trainval_exp3_final.h5'
thresh = 0.1
im_path = 'demo'
# ---
...
for i, (image, im_data) in enumerate(pool.imap(
    ...
    # print(bbox_pred, iou_pred, prob_pred)
    det_time = t_det.toc()
    # to numpy
    ...
    print(scores, bboxes, image.shape)
    im2show = yolo_utils.draw_detection(image, bboxes, scores, cls_inds, cfg, thr=thresh)
    ...
    cv2.imwrite(f'result/test_{i}.jpg', im2show)
