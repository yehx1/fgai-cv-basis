...
############################
multi_scale_inp_size = [np.array([320, 320], dtype=np.int_),
                        np.array([352, 352], dtype=np.int_),
                        np.array([384, 384], dtype=np.int_),
                        np.array([416, 416], dtype=np.int_),
                        np.array([448, 448], dtype=np.int_),
                        np.array([480, 480], dtype=np.int_),
                        np.array([512, 512], dtype=np.int_),
                        np.array([544, 544], dtype=np.int_),
                        np.array([576, 576], dtype=np.int_),
...
inp_size = np.array([416, 416], dtype=np.int_)   # w, h
...
DATA_DIR = os.path.join(ROOT_DIR, '../../01_data/VOC')
MODEL_DIR = os.path.join(ROOT_DIR,  'models')
TRAIN_DIR = os.path.join(MODEL_DIR, 'training')
TEST_DIR = os.path.join(MODEL_DIR, 'training')
