...
```
## 2. 下载预训练模型
- 本项目已训练模型存储路径：../../02_models/fgai_trained_models/chapter06/09_pytorch-YOLO-v1/best.pth。
## 3. fgai-cv-basis运行方式
```
cd chapter06/09_pytorch-YOLO-v1
# 训练程序，模型文件保存于result/best.pth
python train.py
# 推理程序，推理结果保存于chapter06/09_pytorch-YOLO-v1/result.jpg
python predict.py
```
![alt text](result.jpg)
