...
```
## 2. 下载预训练模型
- 本项目已训练模型存储路径：../../02_models/fgai_trained_models/chapter06/12_efficientdet-pytorch/model_best.pth.tar。
## 3. fgai-cv-basis运行方式
```
cd 12_efficientdet-pytorch
# 如果无法连上Hugging Face
export HF_ENDPOINT=https://hf-mirror.com

# 训练程序，模型文件保存于chapter06/12_efficientdet-pytorch/output/train
python train.py
```
