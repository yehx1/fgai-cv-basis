...
class Coco2017Cfg(CocoCfg):
    ...
    splits: Dict[str, dict] = field(default_factory=lambda: dict(
        train=dict(ann_filename='annotations/instances_train2017.json', img_dir='images/train2017', has_labels=True),
        val=dict(ann_filename='annotations/instances_val2017.json', img_dir='images/val2017', has_labels=True),
