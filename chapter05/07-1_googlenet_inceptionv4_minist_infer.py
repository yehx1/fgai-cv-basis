...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load(f'{current_dir}/../02_models/fgai_trained_models/chapter05/inceptionv4_mnist.pth'))
    ...
    transform = transforms.Compose([
        transforms.Resize((299, 299)),  # VGG16 需要输入 224x224 的图像
    ...
    # 保存图像
    save_path = os.path.join(save_dir, 'inceptionv4_infer.png')
