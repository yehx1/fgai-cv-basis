...
# 定义 ResNet50 模型，修改输入通道和全连接层
class ResNet50(nn.Module):
    def __init__(self, num_classes=10):
        super(ResNet50, self).__init__()
        # 使用预训练的 ResNet50 模型，并进行自定义修改
...
if __name__ == '__main__':
    ...
    torch.save(model.state_dict(), f'{save_dir}/resnet50_mnist.pth')
    print(f'model save path: {save_dir}/resnet50_mnist.pth')

    plot_metrics(train_losses, accuracies, f'{save_dir}/resnet50_loss_accuracy_curve.png')