...
def plot_metrics(train_losses, accuracies, save_path):
    ...
    # 保存模型
    torch.save(model.state_dict(), f'{save_dir}/vgg16_mnist.pth')
    print(f'model save path: {save_dir}/vgg16_mnist.pth')

    # 绘制并保存损失和准确率曲线
    plot_metrics(train_losses, accuracies, f'{save_dir}/vgg16_loss_accuracy_curve.png')