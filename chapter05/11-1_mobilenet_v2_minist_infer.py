...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load(f'{current_dir}/../02_models/fgai_trained_models/chapter05/mobilenetv2_mnist.pth'))
    ...
    # 保存图像
    save_path = os.path.join(save_dir, 'mobilenetv2_infer.png')
