...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load(f'{current_dir}/../02_models/fgai_trained_models/chapter05/shufflenet_mnist.pth'))
    ...
    transform = transforms.Compose([
        transforms.Resize((224, 224)),  # ResNet50 需要输入 224x224 的图像
        transforms.ToTensor(),
    ...
    # 保存图像
    save_path = os.path.join(save_dir, 'shufflenet_infer.png')
