...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='yolov9s.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='models/detect/yolov9-s.yaml', help='model.yaml path')
...
if __name__ == "__main__":
    if os.path.exists('/root/project/fgai-cv-basis/01_data/coco128/labels.cache'):
        os.remove('/root/project/fgai-cv-basis/01_data/coco128/labels.cache')
    opt = parse_opt()
    main(opt)
