...
def dist2bbox(distance, anchor_points, box_format='xyxy'):
    ...
    lt, rb = torch.split(distance, 2, -1) # 直接预测的是相对锚点中心的左上与右下坐标
    x1y1 = anchor_points - lt # torch.Size([b, 8400, 2])
    x2y2 = anchor_points + rb # torch.Size([b, 8400, 2])
    if box_format == 'xyxy':
    ...
    return bbox # torch.Size([b, 8400, 4])
