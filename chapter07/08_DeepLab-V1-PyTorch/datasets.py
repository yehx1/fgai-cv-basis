...
class VOCDataset(torch.utils.data.Dataset):
    def __init__(self, root, split='train_aug', crop_size=321, label_dir_path='SegmentationClass', is_scale=True, is_flip=True):
        self.root = root
        ...
        self.id_path = os.path.join(self.root, 'ImageSets', 'Segmentation', split + '.txt')
