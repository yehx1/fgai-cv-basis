...
```
## 2. 下载预训练模型
- 本项目已训练模型存储路径：../../02_models/fgai_trained_models/chapter07/12_Pytorch-UNet/checkpoint_last.pth
## 3. fgai-cv-basis运行方式
```
cd chapter07/12_Pytorch-UNet

# 训练程序，模型文件保存于chapter07/12_Pytorch-UNet/checkpoints/checkpoint_last.pth
python train.py

# 推理程序，推理结果保存于chapter07/12_Pytorch-UNet/output.jpg
python predict.py
```
![alt text](output.jpg)
